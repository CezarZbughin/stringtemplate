...
#
#
execute if data storage stringtemplate:parser.scope parse.in.tokens[0].VAR run \
    return run function stringtemplate:parser/internal/parse..var
execute if data storage stringtemplate:parser.scope parse.in.tokens[0].FOR run \
    return run function stringtemplate:parser/internal/parse..for
execute if data storage stringtemplate:parser.scope parse.in.tokens[0].IN run \
...
execute if data storage stringtemplate:parser.scope parse.in.tokens[0].DO run \
...
execute if data storage stringtemplate:parser.scope parse.in.tokens[0].ENDFOR run \
    return run function stringtemplate:parser/internal/parse..endfor

execute if data storage stringtemplate:parser.scope parse.in.tokens[0].IF run \
    return run function stringtemplate:parser/internal/parse..if
execute if data storage stringtemplate:parser.scope parse.in.tokens[0].THEN run \
...
execute if data storage stringtemplate:parser.scope parse.in.tokens[0].ELSE run \
    return run function stringtemplate:parser/internal/parse..else
execute if data storage stringtemplate:parser.scope parse.in.tokens[0].ENDIF run \
    return run function stringtemplate:parser/internal/parse..endif

return run function stringtemplate:parser/internal/parse..str
