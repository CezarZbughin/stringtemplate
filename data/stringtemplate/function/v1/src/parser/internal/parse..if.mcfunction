...
data modify storage stringtemplate:parser.scope parse.local.char set value ""
data modify storage stringtemplate:parser.scope parse.local.char set \
    string storage stringtemplate:parser.scope parse.local.predicate 0 1
...
data modify storage stringtemplate:parser.scope parse.local.stack[0][-1].if.predicate_separator set \
    value "."
execute if data storage stringtemplate:parser.scope parse.local{char:"{"} run \
    data modify storage stringtemplate:parser.scope parse.local.stack[0][-1].if.predicate_separator set \
    value ""
